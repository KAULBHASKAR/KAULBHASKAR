...
// ✅ Lazy load CalendarComponentimport React, { lazy, Suspense, useEffect } from "react";
// Import Helmet directly to bypass SEO prop type errors
import { Helmet } from "react-helmet-async";
// Removed useLocation to prevent Router context errors
import LatestPost from "../components/LatestPost";
...
const About: React.FC = () => {
  ...
  // JSON-LD AboutPage & Person Schema Definition
  const aboutSchema = {
    ...
    "mainEntity": {
      ...
      "image": "https://www.kaulbhaskar.com/img/satyendra-large.webp",
      "knowsAbout": [
        "Tantra",
        "Astrology",
        "Sri Vidya Upasana",
  ...
  return (
    <div className="flex flex-col w-full content-center">
      {/* 1. Corrected canonical path to match your sitemap.xml routing */}
      <SEO
        ...
        canonical="https://www.kaulbhaskar.com/about"
      ...
      <Helmet>
        ...
        <meta name="twitter:url" content="https://www.kaulbhaskar.com/about" />
      ...
      <section className="flex-row md:flex mx-auto items-center w-full bg-gradient-to-r from-green-400 via-indigo-500 to-yellow-400">
        ...
        <div className="sm:mt-0 sm:w-2/3 w-full mt-6 ml-0 p-10">
          ...
          <p className="text-lg text-simple text-justify">
            ...
            more than 30 years painstakingly perfecting his practice of SRI VIPYA UPASANA of highly mysterious{" "} <strong>DAKSHINAMURTI SAMPRADAYA</strong>.
  ...
  return (
    <div className="flex flex-col w-full content-center">
      ...
      <Helmet>
        ...
        <meta property="og:title" content="About Kaulbhaskar Guru Ji | Tantra & Strategic lifepath maping Experts" />
        <meta property="og:description" content="Learn about Kaulbhaskar Guru Ji, a direct disciple of Sri Kulbhushananand Nath, and our team of experts in Tantra, Astrology, and Sri Vidya Upasana." />
        <meta property="og:image" content="https://www.kaulbhaskar.com/img/satyendra-large.webp" />
        ...
        <meta name="twitter:title" content="About Kaulbhaskar Guru Ji | Tantra & Strategic lifepath maping Experts" />
        <meta name="twitter:description" content="Learn about Kaulbhaskar Guru Ji, a direct disciple of Sri Kulbhushananand Nath, and our team of experts in Tantra, Astrology, and Sri Vidya Upasana." />
        <meta name="twitter:image" content="https://www.kaulbhaskar.com/img/satyendra-large.webp" />
      </Helmet>
